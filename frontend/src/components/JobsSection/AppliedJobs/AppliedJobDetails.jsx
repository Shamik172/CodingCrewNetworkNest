...
const AppliedJobDetails = ({hadlerModal}) => {


  return (
      <div className="flex fixed top-16 left-0 right-0 bottom-0 w-full min-h-screen bg-slate-300 dark:bg-slate-950 z-20 ">
      <div className="cursor-pointer" onClick={()=>{hadlerModal(false)}}>Back</div>
